sap.ui.define([
	...
	"sap/ui/Device",
	"com/duxinnovation/ehs/registroocorrencias/model/models",
	"com/duxinnovation/ehs/registroocorrencias/controller/ErrorHandler"
], function(UIComponent, Device, models, ErrorHandler) {
	"use strict";

	return UIComponent.extend("com.duxinnovation.ehs.registroocorrencias.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "com.duxinnovation.ehs.registroocorrencias.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "com.duxinnovation.ehs.registroocorrencias.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/ZOCORRENCIAS_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "com.duxinnovation.ehs.registroocorrencias.view",
					"controlId": "app",
