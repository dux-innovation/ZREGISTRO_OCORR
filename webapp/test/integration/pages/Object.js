sap.ui.define([
	...
	"com/duxinnovation/ehs/registroocorrencias/test/integration/pages/shareOptions"
				...
				theShareTileButtonShouldContainTheRememberedObjectName: function() {
					return this.waitFor({
						...
						matchers: function(oButton) {
							var sObjectName = this.getContext().currentItem.getBindingContext().getProperty("IdOcorre");
